...
# ---------------------------------------------------------------------------
# Sites 8+9 (delegate.applied / delegate.application_decided) removed
# in Phase 30.1 B4 alongside the legacy DelegateApplication surface.
# Phase 19's delegate_application_submitted / _approved / _denied
# events are exercised via the per-profile-id flow tests elsewhere.
# ---------------------------------------------------------------------------
