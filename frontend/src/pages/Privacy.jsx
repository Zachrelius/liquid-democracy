  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-[var(--brand-primary)] mb-8">Privacy Policy</h1>
        ...
        <div className="prose prose-sm max-w-none text-[#2C3E50] space-y-6">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">What Data We Collect</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">How Data Is Stored</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">Who Can See Your Data</h2>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">Data Retention</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">Data Export</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">Account Deletion</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">Third-Party Sharing</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[var(--brand-primary)] mt-8 mb-3">Contact</h2>
            <p>
